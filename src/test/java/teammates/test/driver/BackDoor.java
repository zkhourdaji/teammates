...
public final class BackDoor {
    ...
    public static FeedbackQuestionAttributes getFeedbackQuestion(String feedbackSessionName,
            String courseId, String questionId) {
        String jsonString = getFeedbackQuestionForIdAsJson(feedbackSessionName, courseId, questionId);
        return Utils.getTeammatesGson().fromJson(jsonString, FeedbackQuestionAttributes.class);
    }
    
    public static String getFeedbackQuestionForIdAsJson(String feedbackSessionName,
            String courseId, String questionId) {
    ...
    public static String deleteFeedbackQuestion(String courseId, String feedbackSessionName, String questionId) {
