...
import teammates.common.util.BackDoorOperation;
...
public final class BackDoor {
    ...
    public static String editStudent(String originalEmail, StudentAttributes student) {
        ...
        params.put(BackDoorOperation.PARAMETER_JSON_STRING, Utils.getTeammatesGson().toJson(student));
        return makePostRequest(params);
    }
    ...
    public static String editFeedbackSession(FeedbackSessionAttributes updatedFeedbackSession) {
        ...
        params.put(BackDoorOperation.PARAMETER_JSON_STRING, Utils.getTeammatesGson().toJson(updatedFeedbackSession));
        return makePostRequest(params);
    }
    ...
    public static String editFeedbackQuestion(FeedbackQuestionAttributes updatedFeedbackQuestion) {
        ...
        params.put(BackDoorOperation.PARAMETER_JSON_STRING, Utils.getTeammatesGson().toJson(updatedFeedbackQuestion));
        return makePostRequest(params);
    }
